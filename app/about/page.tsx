export default function About() {
  return (
    ...
    <p className="leading-relaxed"></p>
      ...
      <p className="leading-relaxed">
        I&apos;m curious, hands on, and always looking to try something new. If you&apos;re interested, feel free to <a href="mailto:***REMOVED***" className="text-cyan-600 underline">reach out via email</a>!
      </p>
    </main>
  );
}